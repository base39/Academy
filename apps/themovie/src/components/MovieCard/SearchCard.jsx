...
import { CardMediaSearch, CardSearch, DateStyled, BoxOverview, Overview } from './style'
    ...
    <Container>
      <CardSearch>
        <NoStyleLink to={`/movie/${id}`}>
          <CardMediaSearch
            image={hasPosterPath ? `//image.tmdb.org/t/p/w94_and_h141_bestv2/${poster_path}` : 'https://i.ibb.co/LPR2G8X/image.png'}
            title={`${title}`}
          />
        </NoStyleLink>
        <CardContent>
